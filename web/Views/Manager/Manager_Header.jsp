    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="${pageContext.request.contextPath}/ManagerController">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="${pageContext.request.contextPath}/ManagerController?action=ANALYTICS">
            ...
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/ManagerController?action=LIST">
            ...
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/VendorController">
                <i class="ni ni-single-02 text-info"></i>
                <span class="nav-link-text">Manage Vendors</span>
              </a>
            </li>
          
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/GlobalConfig">
