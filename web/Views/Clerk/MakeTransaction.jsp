...
<div class="info">
    <body>
        ...
        <form  method="GET" name="entryForm" action="ValidateClerkTransaction">
            ...
            <div class="row">
                ...
                <div class="col">
                    <input class="form-control" type="number" name="quantity" placeholder="quantity" min="1" step="1" required/>  
...
<form action="ValidateClerkTransaction" name="checkoutform" method="post">
    <div class="row">
        <div class="col">
