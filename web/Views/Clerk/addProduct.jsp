...
<div class="info">
    <body>
        ...
        <form action = "${pageContext.request.contextPath}/ClerkController"  method="POST" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <select class="form-control" name="vendor" value="${product.vendorName}" placeholder="Select Vendor">
                        <option value="${product.vendorName}" placeholder="Select Vendor" disbled selected>Vendor Name</option>
                        <%
                            try {
