...
public class WarehouseManager extends HttpServlet {
    ...
    public void WMDashBoard(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
           ...
           // List<Product> list = productDAO.get();
            ...
            int transCount = us.getTransactionCount();
            int vendorCount = us.getVendorCount();
           // int products =  us.getProductCount();
             List<Transaction> list = productDAO.getTrans();
             List<Product> list2 = productDAO.get();
            ...
            dispatcher = request.getRequestDispatcher("/Views/WarehouseManager/Dashboard.jsp");
