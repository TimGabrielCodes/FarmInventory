    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="${pageContext.request.contextPath}/ClerkController">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/ClerkController?action=LIST">
                <i class="ni ni-shop text-orange"></i>
                <span class="nav-link-text">Warehouse</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/ClerkController?action=ADD">
                <i class="ni ni-cart text-primary"></i>
                <span class="nav-link-text">Add Products</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/ClerkController?action=SELL">
                <i class="ni ni-money-coins text-primary"></i>
                <span class="nav-link-text">Make Transaction</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="${pageContext.request.contextPath}/ClerkController?action=TRANSACTIONS">
                <i class="ni ni-user-run text-primary"></i>
                <span class="nav-link-text">Your Transactions</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
